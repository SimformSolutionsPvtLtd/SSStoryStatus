...
var mockData: [UserModel] = [
    ...
    UserModel(name: "KP1", image: mockImage, stories: [StoryModel(id: "test_video" ,mediaURL: storyImages[0], date: Date.now, information: "Don Meldi", duration: 10, mediaType: .image, storyState: .seen) ]),
    UserModel(name: "KP2", image: mockImage, stories: [StoryModel(id: "test_video" ,mediaURL: storyImages[1], date: Date.now, information: "Don Meldi", duration: 10, mediaType: .image, storyState: .seen) ]),
    UserModel(name: "KP3", image: mockImage, stories: [StoryModel(id: "test_video" ,mediaURL: storyImages[2], date: Date.now, information: "Don Meldi", duration: 10, mediaType: .image, storyState: .seen) ]),
