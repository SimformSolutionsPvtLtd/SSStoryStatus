...
//    
    ...
    UserModel(name: "Ankit", image: mockImage, stories: [StoryModel(id: "test_video" ,mediaURL: storyVideo, date: Date.now, information: "Don Meldi", duration: 10, mediaType: .video, storyState: .seen) ]),
    ...
    UserModel(name: "KP1", image: mockImages[0], stories: [StoryModel(id: "test_video" ,mediaURL: storyImages[0], date: Date.now, information: "Don Meldi", duration: 10, mediaType: .image, storyState: .seen) ]),
    UserModel(name: "KP2", image: mockImages[1], stories: [StoryModel(id: "test_video" ,mediaURL: storyImages[1], date: Date.now, information: "Don Meldi", duration: 10, mediaType: .image, storyState: .seen) ]),
    UserModel(name: "KP3", image: mockImages[2], stories: [StoryModel(id: "test_video" ,mediaURL: storyImages[2], date: Date.now, information: "Don Meldi", duration: 10, mediaType: .image, storyState: .seen) ]),
